...
<section class="wow fadeIn parallax slider-img" data-stellar-background-ratio="0.5" style="background-image: url(<?= base_url("assets/frontend/")?>images/taj_mahal.png); background-position: 0px -16.5px; visibility: visible; animation-name: fadeIn;">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 d-flex flex-column justify-content-center text-center medium-screen page-title-extra-large">
                        <!-- start page title -->
                        <h1 class="text-white-2 alt-font font-weight-600 letter-spacing-minus-1 ">Global Obituaries & Memorials</h1>
